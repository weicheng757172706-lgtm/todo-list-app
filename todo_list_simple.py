...
# -*- coding: utf-8 -*-
"""
Todo List Application - Simplified version without openpyxl
"""
...
class TodoApp:
    ...
    def setup_completed_tab(self, parent):
        ...
        refresh_completed_btn = ttk.Button(toolbar, text="🔄 刷新", command=self.refresh_completed)
    ...
    def refresh_pending(self):
        ...
        for priority, color in self.priority_colors.items():
            self.pending_tree.tag_configure(priority, background=color + "40")
